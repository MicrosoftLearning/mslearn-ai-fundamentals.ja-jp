---
lab:
  title: Microsoft Foundry でテキストを分析する (非推奨)
...
# Microsoft Foundry でテキストを分析する (非推奨)

> **注**: この演習は非推奨となり、間もなく削除されます。 代替の演習 (<https://go.microsoft.com/fwlink/?linkid=2347911>) を完了することを検討してください。
