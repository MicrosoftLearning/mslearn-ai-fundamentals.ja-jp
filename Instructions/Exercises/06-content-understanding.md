---
lab:
  title: Microsoft Foundry で Content Understanding を使用してデータを抽出する (非推奨)
...
# Microsoft Foundry で Content Understanding を使用してデータを抽出する (非推奨)

> **注**: この演習は非推奨となり、間もなく削除されます。 代替の演習 (<https://go.microsoft.com/fwlink/?linkid=2347369>) を完了することを検討してください。
