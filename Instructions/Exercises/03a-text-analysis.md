...
1. **[エージェントの作成]** を選択します。 その後、次の設定で新しいプロジェクトを作成します。
...
1. プロジェクトが作成されると、プロジェクトのホーム ページが表示されます。 左側のメニューに移動します (上部のアイコンをクリックして展開しなければならない場合があります)。 **[プレイグラウンド]** をクリックします。 

1. **[言語プレイグラウンド]** を選択します。 Language プレイグラウンドは、いくつかの Azure Language 機能を試用できるユーザー インターフェイスです。  
