...
![Anton の画像。](./media/anton-icon.png)<br/>**こんにちは、Anton です。**<br/>このラボで、Microsoft Foundry Tools の Azure Speech を使って音声対応エージェントを作成する手順を進められるよう、ヒントやコツを使ってサポートします。
...
> ![Anton の画像。](./media/anton-icon.png)<br/>**ヒント**: 音声入力は静かな環境でマイクやヘッドセットを使う場合に適しています。
...
1. アプリの状態が **Processing…** に変わったことを確認します。 このアプリは音声入力を処理します。
    ...
    処理速度が非常に速く、実際には、状態が *[話し中]* に戻る前に、状態が表示されない場合があります。
