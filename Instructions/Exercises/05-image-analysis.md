---
lab:
  title: Microsoft Foundry で画像を分析する (非推奨)
...
# Microsoft Foundry で画像を分析する (非推奨)

> **注**: この演習は非推奨となり、間もなく削除されます。 <https://go.microsoft.com/fwlink/?linkid=2347912> で代替の演習を完了することを検討してください。
...
1. プロジェクトが作成されると、プロジェクトのホーム ページが表示されます。 左側のメニューに移動し (メニューの上部のアイコンをクリックして展開することが必要になる場合があります)、**[AI サービス]** を選択します。
