...
1. Azure Machine Learning ワークスペース リソースで、**[スタジオの起動]** を選択します (または新しいブラウザー タブを開いて [https://ml.azure.com](https://ml.azure.com?azure-portal=true) に移動し、Microsoft アカウントを使用して Azure Machine Learning スタジオにサインインします)。 表示されているメッセージがあれば閉じます。
